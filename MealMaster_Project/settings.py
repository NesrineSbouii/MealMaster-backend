"""
Django settings for MealMaster_Project project.
...
SECRET_KEY = 'django-insecure-xe0)ci1*keubp&ucr$x&&@rurmi-70w2hvgpn$=z-tyfv80g#d'
...
WSGI_APPLICATION = 'MealMaster_Project.wsgi.application'
